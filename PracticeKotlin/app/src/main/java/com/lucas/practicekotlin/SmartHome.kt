...
class SmartHome(
    ...
    // can only be done if light is on
    fun turnOnLight() {
        deviceTurnOnCount++
...
// //     smartDevice.increaseSpeakerVolume() // this line doesn't work
...
//     smartDevice.printDeviceInfo()
    ...
    var smartHome = SmartHome(smartTv, smartLight)
    smartHome.turnOnTv()
